...
# NOTE: The system prompt below guides the LLM to build a camera position tree.
# The key insight is that parent cameras have wider/larger shots that encompass
# the content of child cameras (e.g., medium shot -> close-up).
# Ref: https://github.com/HKUDS/ViMax
